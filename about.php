...
$changelog = array(
	'0.9.x' => array(
		'0.9.1' => array(
			array('u',"В синхронизацию видео добавлен дополнительный этап для получения приватных видео."),
		),
		'0.9.0' => array(
			array('n',"Добавлена синхронизация комментариев"),
		),
	),
	'0.8.x' => array(
		'0.8.13' => array(
			array('n',"Добавлен исталлятор"),
			array('n',"Стена: добавлена возможность поиска текста и фильтр по дате."),
			array('n',"Добавлен Air Datepicker"),
			array('u',"Небольшие правки"),
			array('bf',"Исправлена ошибка при сохранении превью для видео в некоторых случаях."),
			array('bf',"Исправлена ошибка при сохранении видео со стены."),
		),
		'0.8.12' => array(
